        ...
        <div id="pricing-section" className="py-20 scroll-mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center">
              {/* Plano Starter */}
              <div className="bg-white p-10 rounded-2xl border border-light-border hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer flex flex-col">
              ...
              {/* Plano Pro */}
              <div className="bg-[#FCEEF3] p-10 rounded-2xl border-2 border-accent-pink hover:-translate-y-2 hover:shadow-2xl hover:shadow-pink-500/30 transition-all duration-300 cursor-pointer flex flex-col transform md:scale-105">
              ...
              {/* Plano Enterprise */}
              <div className="bg-[#E8F8EE] p-10 rounded-2xl border border-green-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 cursor-pointer flex flex-col">
                <div className="text-center mb-6">
