        ...
        <div id="pricing-section" className="py-20 scroll-mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center">
              {/* Plano Starter */}
              <div className="bg-white p-10 rounded-2xl border border-light-border hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer flex flex-col">
              ...
              {/* Plano Enterprise */}
              <div className="bg-[#E8F8EE] p-10 rounded-2xl border border-green-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 cursor-pointer flex flex-col">
                <div className="text-center mb-6">
